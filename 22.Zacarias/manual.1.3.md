...
El tono observado es 666 declaraciones · 39 mandatos. Las órdenes existen; de lejos, el clima es de declaración.
...
- *Porque así dice Jehová de los ejércitos*
  * *porque* (כִּ֣י)[^yaan] introduce la razón de *sean fuertes sus manos*.
  * *Jehová de los ejércitos* → *dice*
...
- *porque todas estas que aborrecí, declara Jehová*
  * *porque* (כִּ֧י)[^yaan] introduce la razón de *ni amen juramento de mentira*.
...
- *porque hemos oído*
  * *porque* (כִּ֥י)[^yaan] introduce la razón de *Iremos*.
...
- *porque de Jehová es el ojo del hombre y todas las tribus de Israel*
  * *porque* (כִּ֣י)[^yaan] introduce la razón de *Carga de la palabra de Jehová*.
  * Cláusula nominal: en hebreo esta cláusula no tiene verbo finito; el español lo suple para poder leerse.
...
- *porque es muy sabia*
  * *porque* (כִּ֥י)[^yaan] introduce la razón de *también Hamat confina*.
...
- *y Ecrón, porque su esperanza ha sido avergonzada*
  * *porque* (כִּֽי)[^yaan] introduce la razón de *Ecrón*.
...
- *porque ahora he visto con mis ojos*
  * *porque* (כִּ֥י)[^yaan] introduce la razón de *no pasará más*.
...
+ *anuncio*
  * ↳ *anuncio* (מַגִּ֥יד)[^P]
  ...
  - *Porque he tensado para mí a Judá*
    * *Porque* (כִּֽי)[^yaan] introduce la razón de *el doble te devolveré*.
...
- *porque piedras de diadema ondeando sobre su tierra*
  * *porque* (כִּ֚י)[^yaan] introduce la razón de *los salvará*.
...
- *Porque ¡qué su bondad*
  * *Porque ¡* (כִּ֥י)[^yaan] introduce la razón de *los salvará*.
...
- *Porque los terafines hablaron iniquidad*
  * *Porque* (כִּ֧י)[^yaan] introduce la razón de *Pidan de Jehová*.
...
- *porque no hay pastor*
  * *porque* (כִּֽי)[^yaan] introduce la razón de *son afligidos*.
...
- *porque visitó Jehová de los ejércitos su rebaño, la casa de Judá*
  * *porque* (כִּ֣י)[^yaan] introduce la razón de *se encendió mi ira*.
...
- *porque Jehová está con ellos*
  * *porque* (כִּ֥י)[^yaan] introduce la razón de *pelearán*.
...
- *porque me apiadé de ellos*
  * *porque* (כִּ֣י)[^yaan] introduce la razón de *los haré volver*.
...
- *porque yo soy Jehová su Dios*
  * *porque* (כִּ֗י)[^yaan] introduce la razón de *los haré volver*.
...
- *porque los redimí*
  * *porque* (כִּ֣י)[^yaan] introduce la razón de *los reuniré*.
...
- *porque cayó el cedro*
  * *porque* (כִּֽי)[^yaan] introduce la razón de *Aúlla, ciprés*.
...
- *porque bajó el bosque fortificado*
  * *porque* (כִּ֥י)[^yaan] introduce la razón de *Aúllen, encinas de Basán*.
...
- *porque fue devastado su manto*
  * *porque* (כִּ֥י)[^yaan] introduce la razón de *Voz de aullido de los pastores*.
...
- *porque fue devastada la soberbia del Jordán*
  * *porque* (כִּ֥י)[^yaan] introduce la razón de *voz de rugido de leoncillos*.
...
- *que palabra de Jehová es él*
  * *que* (כִּ֥י)[^ki] introduce el contenido de *conocieron*.
...
* *y si* (וְ/אִם)[^conn] une esta cláusula con *den mi salario*.
...
* *Porque* (כִּ֣י)[^yaan] introduce la razón de *Aún toma para ti instrumento de pastor necio*.
...
* *porque* (כִּ֛י)[^yaan] introduce la razón de *No vivirás*.
...
* *porque* (כִּ֥י)[^yaan] introduce la razón de *hombre que trabaja la tierra soy yo*.
...
* *porque* (כִּֽי)[^yaan] introduce la razón de *huirán ustedes el valle de mis montes*.
...
* *como* (כַּ/אֲשֶׁ֤ר)[^kaasher] introduce la comparación de *huirán ustedes*.
