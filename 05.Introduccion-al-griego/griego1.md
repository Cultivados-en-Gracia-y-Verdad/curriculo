---
title: Introducción al Griego para el Estudio Bblico
cover: 
date: 2026-03-02
---
...
- Una traducción nunca es tan preciso como el idioma original.
...
### Esperamos que este estudio sea de mucho provecho en tus estudios de la Palabra de Dios, especialmente para la comprensión del Nuevo Testamento. 

## Aprendamos el Abecedario Griego

Existen dos escuelas de pronunciación de griego. 
- El moderno
- Erasmiana

### En este curso, nosotros usaremos la pronunciación "erasmiana". 

# Alfa
![Alfa](images/alfa.png)

# Beta
![Alfa](images/beta.png)

# Gama
![Alfa](images/gamma.png)

# Delta
![Alfa](images/delta.png)

# Epsilon
![Alfa](images/epsilon.png)

# Zeta
![Alfa](images/zeta.png)

# Eta
![Alfa](images/eta.png)

# Theta
![Alfa](images/theta.png)

# Iota
![Alfa](images/iota.png) 

# Kapa
![Alfa](images/kappa.png)

# Lambda
![Alfa](images/lambda.png) 
...
# Sigma
![Alfa](images/sigma.png)

# Tau
![Alfa](images/tau.png)

# Upsilon
![Alfa](images/upsilon.png)
...
### La letra Sigma tiene dos formas de escribir en minúscula. Cuando la sigma cae al início o al medio, se escribe "σ" pero cuando cae al final de la palabra se escribe "ς". 

### Las palabras en griego pueden terminar en cualquier vocal y solo en tres consonantes: **ν, ρ, ς**. Las excepciones son las palabras de origen extranjero, como los nombres personales judíos y las ubicaciones geográficas en las Escrituras griegas.

###  Marcas de Respiración
### Cuando una palabra empieza por una vocal o un diptongo (combinación de vocales), recive o una marca de respiración suave o una marca áspera. Una marca de respiración suave es (**᾽**) y una marca de respiración áspera es (**῾**).

###  Acentos
### El griego contiene tres tipos de acentos; agudo  (`), grave (´) y circunflejo (~). Estos ocurren encima de la vocal y tienen el efecto de dar enfasis a ese silabo. 
...
### Las preposiciones son palabras que expresan la relación entre el sustantivo o pronombre con otra parte de la oración. Por ejemplo, in la oración... 
> "Yo caminé **por** el campo" 
### La palabra por es una preposición que expresa como el sujeto (yo) y el campo interactuarón. 
...
### El verbo griego es el corazón de la oración griega y tiene varios componentes (en orden de RMAC):
###### 1. Tiempo
###### 2. Voz
###### 3. Modo
###### 4. Persona 
...
### La función principal de los adverbios en griego koiné es modificar verbos. Sin embargo, los adverbios pueden modificar adjetivos u otros adverbios. Principalmente, sin embargo, un adverbio modifica la forma en que un se usa el verbo. Mientras que un adjetivo describe un sustantivo, un adverbio modifica la forma en que se usa el verbo.
...
|2nda Persona|singular| tu |
|3ra Persona |singular| el/ella/eso/ellos|
...
| |Singular | Plural|
|---|---|---|
|1| ἀκούω - yo oigo | ἀκούομεν - nosotros oimos |
|2| ἀκούεις - tu oyes | ἀκούετε - ustedes oyen |
|3| ἀκούει - el/ella/aquel oye | ἀκούουσιν - ellos oyen |

| |Singular | Plural|
|---|---|---|
|1| ἀκού**ω** - yo oigo | ἀκού**ομεν** - nosotros oimos |
|2| ἀκού**εις** - tu oyes | ἀκού**ετε** - ustedes oyen |
...
##### i. **Presente** – "él dice" o "él está diciendo"
###### Algo que ocurre ahora. Puede ser continuo o un punto de acción en el presente - el contexto lo determina. 

##### ii. **Imperfecto** - "Estaba diciendo"
###### Habitual, repetido o acción continua en el pasado. Describe algo que estaba en un proceso de suceder. Solo sucede en el modo imperfecto. 
>Le estaba pegando bien a la pelota ayer.

##### iii. **Futuro** - "dirán"
###### El koine solo tiene un tiempo para describir algo que sucederá en el futuro. El contexto determina si es un punto de acción o si es contínuo. 

##### IV. **Aoristo** - "tú dijiste"
###### Punto del tiempo en el pasado, no comenta sobre la duración del evento. 
>Le pegué bien a la pelota ayer

##### V. **Perfecto** – "He dicho"
###### Describe una acción completada en el pasado que tiene resultados que continuan al presente. 

##### VI. **Pluscuamperfecto** - "habías dicho"
...
|Artículos| |
| ---|---|
|Nominativo| el sujeto es típicamente nominativo|
|Genitivo|típicamente traducido usando la palabra "de". Generalmente indica poseción |
|Dativo|típicamente traducido como "a", "en" o "con". El objeto indirecto es típicamente dativo. |
|Acusativo| el objeto directo is típicamente acusativo|
...
|--|--|--|--|--|---|---|---|---|
| |S|P| |S|P| |S|P|
|**N**|-ος |-οι | **1**|-ω(yo)|-ομεν(nosotros)| **Ν**|-ον|-α|
|**G**|-ου |-ων |**2**|-εις(tu)|-ετε(ustedes)| **G**|-ου|-ων|
|**D**|-ς |-οις |**3**|-ει(el)|-ουσιν(ellos)| **D**|-ω|-οις|
|**A**|-ον |-ους |||| **A**|-ον|-α|
> διδάσκαλος λαμβάνει δῶρα
...
|**D**|-ς |-οις |**3**|-ει(el)|-ουσιν(ellos)| **D**|-ω|-οις|
|**A**|-ον |-ους |||| **A**|-ον|-α|
> υἱοί ἀποστόλων λέγουσι λόγον καὶ λύουσι δούλους
...
|**D**|-ς |-οις |**3**|-ει(el)|-ουσιν(ellos)| **D**|-ω|-οις|
|**A**|-ον |-ους |||| **A**|-ον|-α|
> γράφει ἀπόστολος νόμον καὶ λόγους υἱοῖς δοῦλου

## Miscelaneo

### [KoineNT](http://www.koinent.com/)
### [Master Greek](https://mastergreek.com/)
### [Koine Parser](https://www.koineparser.com/)
### [Parsing Greek](https://www.dannyzacharias.net/parsegreek)
