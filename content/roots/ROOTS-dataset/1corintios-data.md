...
- ἀπολλυμένοις (V-PMP-DPM) perdiéndose [NF]
- ἐστίν (V-PAI-3S) ==es== [F]
- σῳζομένοις (V-PPP-DPM) siendo salvados [NF]
- ἐστιν (V-PAI-3S) ==es== [F]
...
- πιστεύοντας (V-PAP-APM) creyendo [NF]
...
## 1Corintios 1:27 {#1co-1-27}

- ἐξελέξατο (V-AMI-3S) ==escogió== [F]
...
## 1Corintios 1:31 {#1co-1-31}

- γέγραπται (V-RPI-3S) ==está escrito== [F]
- καυχάσθω (V-PMM-3S) ==gloríese== [F]
- καυχώμενος (V-PMP-NSM) gloriándose [NF]

→ ἵνα = para que [i]
 → καθὼς = tal como [i]

## 1Corintios 2:1 {#1co-2-1}
...
## 1Corintios 2:14 {#1co-2-14}

- δέχεται (V-PMI-3S) ==acepta== [F]
- ἐστίν (V-PAI-3S) ==es== [F]
- δύναται (V-PNI-3S) ==puede== [F]
- γνῶναι (V-AAN) conocer [NF]
- ἀνακρίνεται (V-PPI-3S) ==se discierne== [F]
...
## 1Corintios 3:7 {#1co-3-7}

ὥστε οὔτε ὁ φυτεύων ἐστίν τι οὔτε ὁ ποτίζων, ἀλλʼ ὁ αὐξάνων θεός.
 [Así que...]

- ἐστίν (V-PAI-3S) ==es== [F]
- φυτεύων (V-PAP-NSM) plantando [NF]
- ποτίζων (V-PAP-NSM) regando [NF]
- αὐξάνων (V-PAP-NSM) dando crecimiento [NF]
...
## 1Corintios 3:10 {#1co-3-10}

- δοθεῖσάν (V-APP-ASF) dada [NF]
...
## 1Corintios 3:11 {#1co-3-11}

- δύναται (V-PNI-3S) ==puede== [F]
- θεῖναι (V-AAN) poner [NF]
- κείμενον (V-PMP-ASM) puesto [NF]
- ἐστιν (V-PAI-3S) ==es== [F]

→ γὰρ = porque [i]
 → ὅς = el cual [i]

## 1Corintios 3:12 {#1co-3-12}
...
- ἐστιν (V-PAI-3S) ==es== [F]
- γέγραπται (V-RPI-3S) ==está escrito== [F]
- δρασσόμενος (V-PMP-NSM) prendiendo [NF]
