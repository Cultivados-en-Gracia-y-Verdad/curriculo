...
##### El propósito se cierra con una definición negativa de carencia.
...
##### El texto termina el versículo con una declaración de resultado: *le será dada*.
...
##### El texto sostiene la afirmación anterior con una imagen de proceso.
...
###### Después de cerrar la cadena (pasión → pecado → muerte), 1:16 introduce una advertencia breve (“no se engañen”), funcionando como corrección inmediata antes del bloque de origen “de lo alto” (1:17–18).
