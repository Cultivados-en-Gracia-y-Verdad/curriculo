...
\begin{itemize}
\item
  \begin{paraHtwo}la acción deja de tener sentido\end{paraHtwo}
\item
  \begin{paraHtwo}la relación se rompe\end{paraHtwo}
\item
  \begin{paraHtwo}👉 eliminaste incorrectamente\end{paraHtwo}
\end{itemize}
...
\begin{quote}
\begin{paraHtwo}``No elimino por sentido --- elimino por estructura.''\end{paraHtwo}
\end{quote}
...
\tightlist
\item
  👉 ¿Qué relación visible en el texto muestra la función de esta
  cláusula?
\end{itemize}
...
\section{ANTES DE CONTINUAR --- LEER EL COMPORTAMIENTO DEL
TEXTO}\label{antes-de-continuar-leer-el-comportamiento-del-texto}

\subsection{LO QUE YA TIENES}\label{lo-que-ya-tienes}
...
\subsection{LO QUE CAMBIA AHORA}\label{lo-que-cambia-ahora}
...
\subsection{DISTINCIÓN CLAVE}\label{distinciuxf3n-clave}
...
\subsection{NO INTERPRETAS
SIGNIFICADO}\label{no-interpretas-significado}
...
\begin{itemize}
\item
  \begin{paraHtwo}👉 Estás observando comportamiento.\end{paraHtwo}
\item
  \begin{paraHtwo}👉 Estás leyendo cómo el texto avanza.\end{paraHtwo}
\end{itemize}

\subsection{SEÑALES QUE DEBES
DETECTAR}\label{seuxf1ales-que-debes-detectar}
...
\begin{itemize}
\item
  \begin{paraHtwo}mismo verbo\end{paraHtwo}
\item
  \begin{paraHtwo}mismo sujeto\end{paraHtwo}
\item
  \begin{paraHtwo}misma forma\end{paraHtwo}
\item
  \begin{paraHtwo}👉 indica unidad\end{paraHtwo}
\end{itemize}
...
\begin{itemize}
\item
  \begin{paraHtwo}desarrollo\end{paraHtwo}
\item
  \begin{paraHtwo}aumento\end{paraHtwo}
\item
  \begin{paraHtwo}cambio de nivel\end{paraHtwo}
\item
  \begin{paraHtwo}👉 indica movimiento\end{paraHtwo}
\end{itemize}
...
\item
  \begin{paraHtwo}pero\end{paraHtwo}
\item
  \begin{paraHtwo}no / sí\end{paraHtwo}
\item
  \begin{paraHtwo}👉 divide bloques\end{paraHtwo}
\end{itemize}
...
\begin{itemize}
\item
  \begin{paraHtwo}hablar → dar → crecer\end{paraHtwo}
\item
  \begin{paraHtwo}👉 posible transición o desarrollo\end{paraHtwo}
\end{itemize}
...
\begin{itemize}
\item
  \begin{paraHtwo}porque → razón\end{paraHtwo}
\item
  \begin{paraHtwo}para que → propósito\end{paraHtwo}
\item
  \begin{paraHtwo}pero → contraste\end{paraHtwo}
\item
  \begin{paraHtwo}👉 no crean el patrón\end{paraHtwo}
\item
  \begin{paraHtwo}👉 lo hacen visible\end{paraHtwo}
\end{itemize}

\subsection{CÓMO LEER EL TEXTO AHORA}\label{cuxf3mo-leer-el-texto-ahora}
...
\subsection{LECTURA GUIADA}\label{lectura-guiada}
...
\begin{paraHtwo}\#\#\#\#\#Ahora observa:\end{paraHtwo}
...
\begin{paraHtwo}Agrupación visible:\end{paraHtwo}
...
\subsection{RESULTADO DE ESTA
SECCIÓN}\label{resultado-de-esta-secciuxf3n}

\headingsix{Ahora puedes:}

\begin{itemize}
\item
  \begin{paraHtwo}detectar repetición\end{paraHtwo}
\item
  \begin{paraHtwo}ver progresión\end{paraHtwo}
\item
  \begin{paraHtwo}identificar contrastes\end{paraHtwo}
\item
  \begin{paraHtwo}notar cambios de sujeto\end{paraHtwo}
\item
  \begin{paraHtwo}seguir cambios de acción\end{paraHtwo}
\item
  \begin{paraHtwo}👉 ya no estás viendo líneas aisladas\end{paraHtwo}
\item
  \begin{paraHtwo}👉 estás viendo comportamiento conjunto\end{paraHtwo}
\end{itemize}

\subsection{LO QUE VIENE}\label{lo-que-viene}
...
\def\labelenumi{\arabic{enumi}.}
\item
  \begin{paraHtwo}Toma el texto del Paso 8 con las etiquetas del Paso 9\end{paraHtwo}
\item
  \begin{paraHtwo}Lee línea por línea\end{paraHtwo}
\item
  \begin{paraHtwo}Haz estas preguntas:\end{paraHtwo}
\end{enumerate}
...
\setcounter{enumi}{3}
\item
  \begin{paraHtwo}Agrupa las líneas que se comportan juntas\end{paraHtwo}
\item
  \begin{paraHtwo}Asigna una etiqueta de patrón al grupo\end{paraHtwo}
\end{enumerate}
...
\begin{paraHtwo}Puedes usar únicamente estos:\end{paraHtwo}

\begin{paraHtwo}REPETICIÓN • PROGRESIÓN • CONTRASTE • CAUSA--RESULTADO • PARALELISMO •
CAMBIO DE SUJETO\end{paraHtwo}

\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={patrones}]{images/patrones.png}}
\caption{patrones}
\end{figure}
...
\begin{paraHtwo}👉 elige la que sea visible en el texto\end{paraHtwo}
