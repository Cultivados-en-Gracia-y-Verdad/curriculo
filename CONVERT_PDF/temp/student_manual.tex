...
\begin{paraHtwo}ROMANOS 9:1-11:36 - Israel y la Fidelidad de Dios\\
ROMANOS 12:1-15:13 - Exhortaciones que surgen del evangelio\\
ROMANOS 15:14-16:27 - Conclusion y Saludos\end{paraHtwo}
...
\begin{paraHtwo}Si tomamos en cuenta
\textbf{todo el patrón gramatical que se repite a lo largo de la carta}
---\end{paraHtwo}
...
\item
  el uso constante de conectores que enlazan ideas (``porque'',
  ``pero'', ``por lo tanto''),
\item
  los contrastes amplios entre dos realidades opuestas,
\item
  y el cambio de afirmaciones (``esto es así'') a exhortaciones (``hagan
  esto'')
\end{itemize}

\begin{paraHtwo}--- podemos ver que no se trata de detalles aislados.\end{paraHtwo}

\begin{paraHtwo}Al observar todo en \fillin{conjunto}, emerge un
\textbf{tema estructural grande}, una línea de pensamiento que avanza de
manera coherente a lo largo de la carta.\end{paraHtwo}
...
\subsection{Conceptos importantes presentados en
Romanos}\label{conceptos-importantes-presentados-en-romanos}

\begin{itemize}
\item
  \begin{paraHtwo}La justicia como \fillin{estatus}, no solo como acto moral\end{paraHtwo}
\item
  \begin{paraHtwo}La justificación \fillin{como} declaración, no como proceso\end{paraHtwo}
\item
  \begin{paraHtwo}La fe \fillin{como} recepción, no como producción\end{paraHtwo}
\item
  \begin{paraHtwo}La presencia ante Dios como algo \fillin{establecido}\end{paraHtwo}
\item
  \begin{paraHtwo}La muerte y la resurrección como algo \fillin{decisivo}\end{paraHtwo}
\item
  \begin{paraHtwo}La unión con \fillin{Cristo} como cambio de identidad\end{paraHtwo}
\item
  \begin{paraHtwo}El pecado como poder gobernante, no \fillin{como} meros actos\end{paraHtwo}
\item
  \begin{paraHtwo}La ley \fillin{como} revelación, no como salvación\end{paraHtwo}
\item
  \begin{paraHtwo}La seguridad basada en la \fillin{acción} de Dios\end{paraHtwo}
\item
  \begin{paraHtwo}Nada queda sin resolver \fillin{desde} el punto de vista de Dios\end{paraHtwo}
\end{itemize}
...
\item
  El cambio de \fillin{nombre} no prueba por sí solo una transformación
  espiritual. El propio \fillin{relato} controla la observación (Hechos
  13:9).
\end{itemize}
...
\tightlist
\item
  Se prometió que \fillin{sería} varón: \scripture{Él…} ---no algo
  impersonal, sino una persona.
\item
...
\item
  Y fue \fillin{Dios} mismo quien lo afirmó:
...
\item
  ...
  versus el \fillin{arcaísmo} de la letra.
\item
  En Romanos 8 el Espíritu es vida, radica en el creyente, adopción,
  resurrección e \fillin{intercesión}.
\end{itemize}
...
\begin{itemize}
\item
  \begin{paraHthree}\textbf{Genitivo subjetivo}\\
  ``La obediencia que \fillin{produce} la fe.''\end{paraHthree}
\item
  \begin{paraHthree}\textbf{Genitivo epexegético o explicativo} ``La obediencia \fillin{que}
  es fe.'' (Es decir, la fe misma descrita como obediencia.)\end{paraHthree}
\item
  \begin{paraHthree}\textbf{Genitivo objetivo} ``La obediencia \fillin{dirigida} hacia la
  fe.'' Esta opción es gramaticalmente menos natural en esta construcción.\end{paraHthree}
\end{itemize}
...
\item
  ...
  por el alarmismo, es una motivación extranjera, \fillin{erronea}. 1
  Timoteo 1:7
\item
  La intimidación no es el \fillin{medio} que promueve obediencia a
  Dios.
\end{itemize}
...
\tightlist
\item
  Aunque \fillin{estén} en Roma, aunque Pablo tal vez no los conoce, son
  amados de Dios.
\end{itemize}
...
\item
  \fillin{Afianzar} el evangelio (el mensaje de Dios) en las Escrituras
  anteriores.
\item
  Identificar a Jesús como el cumplimiento de la \fillin{promesa} de
  Dios.
\item
...
término usado para el servicio sacerdotal de Israel a Yahvé (Éxodo 20:5; Deuteronomio 5:9). Pablo emplea este lenguaje  considera que el ministerio del evangelio es un servicio sagrado a Dios. También usa este término para describir el servicio de los gentiles a Dios (Romanos 12:1; compárese con 2 Timoteo 1:3).
\end{definitionbox}
\end{center}
...
\begin{itemize}
\item
  \begin{paraHthree}La proclamación del evangelio de Pablo no era un \fillin{método} para
  ser salvo.\end{paraHthree}
\item
  \begin{paraHthree}La proclamación del evangelio no es una técnica religiosa. Pablo no
  predicaba un procedimiento, sino una \fillin{persona}.\end{paraHthree}
\end{itemize}
...
\begin{anchorblock}{Por lo cual Dios los entregó a la impureza en la lujuria de sus corazones}
...
\begin{center}
\begin{definitionbox}{entregar - PARADIDOMI}
poner a alguien bajo el control o dominio de algo; ceder a una esfera de influencia. 
\end{definitionbox}
\end{center}

\begin{center}
\begin{definitionbox}{Impureza - AKATHARSIA}
se refiere a inmoralidad entendida como suciedad o contaminación moral, usada especialmente para pecados de carácter sexual.
\end{definitionbox}
\end{center}

\begin{center}
\begin{definitionbox}{Lujuria - EPITHYMIA}
...
\begin{anchorblock}{Porque ellos cambiaron la verdad de Dios por la mentira}
...
\begin{anchorblock}{Romanos 1:25b y adoraron y sirvieron a la criatura en lugar del Creador}
...
\begin{anchorblock}{del Creador, quien es bendito por los siglos. Amén.}
...
\item
  \begin{paraHthree}El pecado redefine valores (lo malo se convierte en bueno) lo que se
  \fillin{honra} y lo que se rechaza.\end{paraHthree}
\item
...
\begin{anchorblock}{Están llenos de toda injusticia, maldad, avaricia, y malicia…}

\headingfive{Esto describe Personas \fillin{dominadas} por injusticia y maldad interior. }

\end{anchorblock}

\begin{anchorblock}{llenos de envidia, homicidios, pleitos, engaños y malignidad}
...
\begin{anchorblock}{Son chismosos, detractores}

\headingfive{Personas que destruyen con la \fillin{lengua}}

\end{anchorblock}

\begin{anchorblock}{aborrecedores de Dios, insolentes, soberbios, jactanciosos e inventores de lo malo}
...
\begin{anchorblock}{desobedientes a los padres, sin entendimiento, indignos de confianza, sin amor, despiadados}
...
\begin{paraHtwo}(Poseer la ley no equivale a cumplirla)\end{paraHtwo}
...
\begin{paraHtwo}(Dios permanece justo y fiel aunque el hombre sea infiel)\end{paraHtwo}
...
\begin{paraHtwo}(declaración judicial universal: no hay justo, ni aun uno)\end{paraHtwo}
...
\begin{itemize}
\item
  \begin{paraHthree}No es por poseer los oráculos de Dios que alguien \fillin{llega} a ser
  justo delante de Él.\end{paraHthree}
\item
  \begin{paraHthree}No es por tener la Ley que uno es declarado \fillin{justo}.\end{paraHthree}
\end{itemize}
...
\begin{paraHtwo}(evidencia escritural que describe la corrupción humana)\end{paraHtwo}
...
\begin{paraHtwo}(la función de la ley no es justificar, sino revelar)\end{paraHtwo}

\subsubsection{Romanos 3:19}\label{romanos-319}
...
(futuro, pasivo, indicativo) indica un  definitivo.
\end{definitionbox}
\end{center}
...
\begin{itemize}
\item
  \begin{paraHthree}La ley cierra \fillin{toda} boca delante de Dios.\end{paraHthree}
\item
  \begin{paraHthree}Su función no es justificar, sino revelar \fillin{culpa}.\end{paraHthree}
\item
  \begin{paraHthree}Ningún ser humano puede ser declarado justo por obras.\end{paraHthree}
\item
  \begin{paraHthree}El conocimiento del pecado \fillin{viene} por medio de la ley.\end{paraHthree}
\item
...
\subsection{Romanos 3:21--26 La justicia revelada por medio de la
fe}\label{romanos-32126-la-justicia-revelada-por-medio-de-la-fe}

\begin{paraHtwo}(Dios \fillin{provee} por medio de la obra de Cristo)\end{paraHtwo}

\begin{paraHtwo}Romanos 3:21--31 forma una unidad argumentativa \fillin{clara}.\end{paraHtwo}

\begin{paraHtwo}Pablo no inicia un nuevo \fillin{tema} aislado, sino que responde
directamente al problema planteado en Romanos 1:18--3:20.\end{paraHtwo}

\begin{paraHtwo}Hasta este punto, el lector ha quedado sin defensa: \fillin{toda} boca
cerrada, toda la humanidad culpable delante de Dios.\end{paraHtwo}

\begin{paraHtwo}A partir de Romanos 3:21, \fillin{Pablo} presenta la solución divina al
problema humano ya demostrado.\end{paraHtwo}

\begin{paraHtwo}El evangelio, anunciado desde Romanos 1:16--17, comienza ahora a ser
explicado con \fillin{precisión}.\end{paraHtwo}

\begin{paraHtwo}Los versículos 21--26 presentan un solo argumento \fillin{continuo}; los
...
opera, \fillin{antes} de mostrar \textbf{qué excluye} y
\textbf{qué establece}.\end{paraHtwo}
...
\begin{paraHthree}\pandocbounded{\includegraphics[keepaspectratio]{images/justificacion.png}}\end{paraHthree}

\begin{paraHthree}https://cdn.pixabay.com/photo/2017/01/13/01/22/rocket-1976107\_1280.png\end{paraHthree}
...
\subsection{Romanos 3:27--31 La jactancia excluida y la ley
confirmada}\label{romanos-32731-la-jactancia-excluida-y-la-ley-confirmada}

\begin{paraHtwo}(la justificación por fe elimina el orgullo humano y une a todos)\end{paraHtwo}

\subsubsection{Romanos 3:27}\label{romanos-327}
...
\begin{itemize}
\item
  \begin{paraHthree}Cambiar de \fillin{estilo} de vida\end{paraHthree}
\item
  \begin{paraHthree}Tener un cambio de \fillin{actitud} frente al pecado\end{paraHthree}
\item
  \begin{paraHthree}Someterse al señorío de \fillin{Cristo} como condición previa o como
  condición posterior para ser justificado\end{paraHthree}
\item
  \begin{paraHthree}Sentir remordimiento suficiente por una vida \fillin{pasada}\end{paraHthree}
\item
  \begin{paraHthree}\fillin{Pedir} a Dios por salvación como acto meritorio\end{paraHthree}
\item
  \begin{paraHthree}Cumplir ciertos pasos espirituales \fillin{antes} de ser aceptado\end{paraHthree}
\end{itemize}
...
\subsubsection{Romanos 3:28}\label{romanos-328}
...
\subsubsection{Romanos 3:29}\label{romanos-329}
...
\subsubsection{Romanos 3:30}\label{romanos-330}
...
\subsubsection{Romanos 3:31}\label{romanos-331}
...
\begin{quote}
\begin{paraHthree}En Síntesis (3:27--31)\end{paraHthree}

\begin{itemize}
\item
  \begin{paraHthree}La justificación por fe excluye toda jactancia humana.\end{paraHthree}
\item
  \begin{paraHthree}Las obras no pueden coexistir con la gracia como base de justificación.\end{paraHthree}
\item
  \begin{paraHthree}Un solo Dios justifica a judíos y gentiles por el mismo principio.\end{paraHthree}
\item
  \begin{paraHthree}La fe no invalida la ley, sino que la confirma.\end{paraHthree}
\item
  \begin{paraHthree}El argumento prepara el camino para el ejemplo de Abraham.\end{paraHthree}
\end{itemize}
\end{quote}

\end{anchorblock}

\subsection{Romanos 4:1--8 Abraham y David: justificación sin
obras}\label{romanos-418-abraham-y-david-justificaciuxf3n-sin-obras}

\begin{paraHtwo}Romanos capítulo 4 funciona \fillin{como} una demostración bíblica que
respalda la afirmación de Romanos 3:21--31.\end{paraHtwo}

\begin{paraHtwo}En Romanos 3, Pablo afirmó que la justificación es por la fe
\fillin{aparte} de las obras de la ley.\end{paraHtwo}

\begin{paraHtwo}En Romanos 4, Pablo demuestra esa afirmación \fillin{usando} la
Escritura misma.\end{paraHtwo}

\begin{paraHtwo}No se introduce un tema \fillin{nuevo}; se confirma y se prueba el
argumento ya establecido.\end{paraHtwo}

\begin{paraHtwo}Pablo no apela a experiencias personales ni a razonamientos filosóficos,
sino a un \fillin{caso} bíblico reconocido por todos: Abraham.\end{paraHtwo}

\begin{paraHtwo}Si la justificación por fe es verdadera, \fillin{debe} ser verificable
en las Escrituras anteriores a la ley.\end{paraHtwo}

\begin{paraHtwo}Abraham es el caso ideal, porque \fillin{vivió} antes de la ley mosaica
y antes de la circuncisión.\end{paraHtwo}

\begin{paraHtwo}Por lo tanto, lo que \fillin{ocurrió} con Abraham establece el principio
de cómo Dios justifica.\end{paraHtwo}

\begin{paraHtwo}Pablo demuestra por las Escrituras que Abraham fue justificado por la fe
\fillin{antes} de la ley y antes de la circuncisión.\end{paraHtwo}

\begin{paraHtwo}Esto significa que su justificación no \fillin{pudo} depender de ninguna
de las dos.\end{paraHtwo}

\begin{paraHtwo}Si Abraham fue \fillin{declarado} justo antes de la ley, entonces la ley
no puede ser el medio de justificación.\end{paraHtwo}

\begin{paraHtwo}Si Abraham fue declarado justo antes de la circuncisión, entonces la
circuncisión no \fillin{puede} ser requisito para la justificación.\end{paraHtwo}

\begin{paraHtwo}El \fillin{orden} histórico es clave para el argumento.\end{paraHtwo}

\begin{paraHtwo}A lo largo de Romanos 4 veremos el uso recurrente del \fillin{verbo}
\scripture{contar}(LOGIZOMAI).\end{paraHtwo}

\begin{paraHtwo}Este verbo pertenece al \fillin{ámbito} contable y judicial.\end{paraHtwo}

\begin{paraHtwo}No describe una transformación moral interna, sino una acreditación
legal.\end{paraHtwo}

\begin{paraHtwo}Algo es \fillin{contado}, imputado o acreditado a la cuenta de alguien.\end{paraHtwo}

\begin{paraHtwo}Cuando Dios \scripture{cuenta} justicia, el verbo aparece en
\fillin{voz} pasiva o media-pasiva.\end{paraHtwo}

\begin{paraHtwo}Esto indica que el \fillin{sujeto} humano no produce la acción. La
justicia no se genera desde el hombre hacia Dios. Es Dios quien actúa, y
el hombre quien recibe.\end{paraHtwo}

\begin{paraHtwo}Cuando el hombre es llamado a \scripture{contar} o
\scripture{considerar} un hecho, el \fillin{verbo} aparece en voz
activa.\end{paraHtwo}

\begin{paraHtwo}En esos \fillin{casos}, el hombre es responsable de reconocer algo como
verdadero.\end{paraHtwo}

\begin{paraHtwo}El hombre no produce justicia, pero sí debe considerar ciertas verdades
como \fillin{reales}. Esto indica que cuando Dios acredita justicia al
hombre, lo hace sin participación humana alguna.\end{paraHtwo}

\begin{paraHtwo}\textbf{El hombre no coopera, no completa, no contribuye.}\end{paraHtwo}

\begin{paraHtwo}Dios \fillin{actúa} soberanamente al justificar. Romanos 4:4, 5, 6, 8,
9, 10, 11, 22, 23, 24; 9:8\end{paraHtwo}

\begin{paraHtwo}En contraste, hay verdades que el creyente \fillin{debe}
\scripture{contar} como verdaderas. Estas verdades no producen
justificación, pero gobiernan la vida del creyente. De esto el hombre es
responsable, no Dios. Romanos 3:28; 6:11; 8:18\end{paraHtwo}

\begin{paraHtwo}Dado que el capítulo es argumentativo e ilustrativo ---no exhortativo---
no encontramos imperativos dirigidos a la \fillin{acción}.\end{paraHtwo}

\begin{paraHtwo}Pablo no está diciendo ``hagan'', \fillin{sino} ``consideren lo que Dios
hizo''. El propósito es establecer certeza doctrinal, no conducta
inmediata.\end{paraHtwo}
...
\item
  Significa no reclamar \fillin{justicia} sobre la base de lo que uno
  hace.
\end{itemize}
...
\item
  La otra categoria es que Dios lo \fillin{hace} y uno no hace nada. Es
  favor.
\end{itemize}
...
\begin{paraHthree}-El impío no tiene \fillin{obras} que presentar.\end{paraHthree}
...
\begin{itemize}
\item
  \begin{paraHthree}No es una evaluación \fillin{pública}.\end{paraHthree}
\item
  \begin{paraHthree}No es la percepción \fillin{humana}.\end{paraHthree}
\item
  \begin{paraHthree}\fillin{No} es la confirmación visible.\end{paraHthree}
\end{itemize}
...
\begin{itemize}
\item
  \begin{paraHthree}Pedir perdón. Da la impresión que debe haber mérito para ser declarados
  \fillin{justos}.\end{paraHthree}
\item
  \begin{paraHthree}Prometer cambiar. Esto implica que es necesario como condición cambiar o
  al menos prometer cambiar tu vida. Es lo \fillin{mismo} que entrar en un
  acuerdo con Dios. Yo cambio, tu me das justicia. Esto no es gracia, es
  un intercambio.\end{paraHthree}
\item
  \begin{paraHthree}Comprometer obediencia \fillin{futura} es una manera de pensar
  equivocada. Va contraria a la justifica por la fe sin obras.\end{paraHthree}
\item
  \begin{paraHthree}Abandonar pecados para ser aceptado, es un pensamiento que dice que
  tienes que limpiarte antes que Dios te acepte. Esto asume muchos
  \fillin{errores}. ¿puedes limpiarte abandonando pecados? ¿Los errores
  pasados con eliminados por dejar de pecar?\end{paraHthree}
\item
  \begin{paraHthree}Orar como requisito justificante. No solo una oración, sino orar con fe.
  Este concepto es simplemente absurdo. \fillin{Orar} con fe o sin fe es
  obra. Orar con mucha fe, sigue siendo obra. La salvación es un regalo no
  algo que mereces.\end{paraHthree}
\end{itemize}
...
\begin{itemize}
\item
  \begin{paraHthree}obras morales, (ser una \fillin{buena} persona, no inmoral)\end{paraHthree}
\item
  \begin{paraHthree}obras religiosas, (pertenecer a una \fillin{religión}, participar en sus
  requisitos)\end{paraHthree}
\item
  \begin{paraHthree}obediencia a la ley, (\fillin{guardar} los 10 mandamientos)\end{paraHthree}
\item
  \begin{paraHthree}prácticas piadosas, (leer tu Biblia, orar, \fillin{asistir} a la
  iglesia)\end{paraHthree}
\item
  \begin{paraHthree}cumplimiento de mandamientos. (\fillin{guardar} tus propias reglas)\end{paraHthree}
\end{itemize}
...
\item
  \fillin{David} demuestra que la justificación implica pecado no
  imputado.
\end{itemize}
...
\subsection{Romanos 4:9--12 Justificación antes de la
circuncisión}\label{romanos-4912-justificaciuxf3n-antes-de-la-circuncisiuxf3n}
...
\subsection{Romanos 4:13--17 La promesa no viene por la
ley}\label{romanos-41317-la-promesa-no-viene-por-la-ley}
...
\subsection{Romanos 4:18--22 La fe contada por
justicia}\label{romanos-41822-la-fe-contada-por-justicia}
...
\item
  Y que esta fe es la base \fillin{sobre} la cual Dios acredita
  justicia.
\end{itemize}
...
\begin{quote}
\begin{paraHthree}En Síntesis (4:23--25)\end{paraHthree}

\begin{itemize}
\item
  \begin{paraHthree}Pablo aplica directamente el argumento al lector.\end{paraHthree}
\item
  \begin{paraHthree}La misma justicia acreditada a Abraham es acreditada a nosotros.\end{paraHthree}
\item
  \begin{paraHthree}La fe tiene como objeto al Dios que resucitó a Jesús.\end{paraHthree}
\item
  \begin{paraHthree}La justificación está ligada a la obra completa de Cristo.\end{paraHthree}
\item
  \begin{paraHthree}Romanos 4 prepara el terreno para la certeza desarrollada en Romanos 5.\end{paraHthree}
\end{itemize}
\end{quote}
...
\begin{anchorblock}{Por tanto, habiendo sido justificados…,}
...
forma perfecta. Estar de pie, estar en una posición de pie;  firmemente establecido, permanecer en una posición o estado. 
\end{definitionbox}
\end{center}
...
\item
  Es un proceso que \fillin{ocurre} porque la aceptación ya fue
  otorgada.
\end{itemize}
...
\subsection{Romanos 5:6--11 Reconciliados por la muerte del
Hijo}\label{romanos-5611-reconciliados-por-la-muerte-del-hijo}

\begin{paraHtwo}(La seguridad del creyente se \fillin{fundamenta} en la obra histórica
de Cristo, no en su experiencia presente)\end{paraHtwo}
...
\item
  No somos salvos en base a como nos cuidamos del \fillin{pecado} en el
  presente.
\item
  No seremos \fillin{salvos} en el futuro porque tuvimos victoria sobre
  el pecado.
\end{itemize}
...
\subsection{Romanos 5:12--14 El pecado y la muerte entraron por un
hombre}\label{romanos-51214-el-pecado-y-la-muerte-entraron-por-un-hombre}

\begin{paraHtwo}(¿Cómo entraron el \fillin{pecado} y la muerte en la experiencia
humana?)\end{paraHtwo}
...
\begin{center}
\begin{definitionbox}{reinó - BASILEUO}
(aoristo, activo, indicativo) gobernar como rey, ejercer autoridad real, dominar, reinar. 
\end{definitionbox}
\end{center}
...
\subsection{Romanos 5:15--17 El don supera la
transgresión}\label{romanos-51517-el-don-supera-la-transgresiuxf3n}

\begin{paraHtwo}(La obra de Cristo no solo revierte el \fillin{daño} de Adán, sino que
lo sobrepasa abundantemente)\end{paraHtwo}

\begin{paraHtwo}En Romanos 5:12--14, Pablo explicó cómo una \fillin{sola} transgresión
introdujo un dominio de pecado y muerte que afectó a toda la humanidad.\end{paraHtwo}

\begin{paraHtwo}El lector ya entiende ahora \textbf{por qué} todos mueren: no es
\fillin{solo} por actos individuales, sino por una condición humana
compartida.\end{paraHtwo}

\begin{paraHtwo}En Romanos 5:15--17, Pablo da el siguiente \fillin{paso} lógico: Si un
solo acto de un solo hombre produjo un efecto tan amplio y devastador,
¿qué sucede cuando otro Hombre actúa, pero esta vez conforme a la gracia
de Dios?\end{paraHtwo}

\begin{paraHtwo}Pablo deja claro desde el inicio que la \fillin{obra} de Cristo
...
\subsection{Romanos 5:18--21 La gracia reina por medio de la
justicia}\label{romanos-51821-la-gracia-reina-por-medio-de-la-justicia}
...
\begin{paraHthree}La ley intensifica la transgresión, \fillin{pero} la gracia reina con
mayor poder\end{paraHthree}
...
\item
  la distinción entre \fillin{Adán} y Cristo como cabezas
  representativas.
\end{itemize}
...
\subsection{Romanos 6:1--2 ¿Perseveraremos en el
pecado?}\label{romanos-612-perseveraremos-en-el-pecado}

\begin{paraHtwo}(La gracia abundante provoca una \fillin{objeción} lógica: si la gracia
reina, ¿importa el pecado?)\end{paraHtwo}

\begin{paraHtwo}Romanos 6:1--10 constituye una unidad argumentativa continua. Esta
unidad está marcada por: una pregunta \fillin{retórica} inicial (6:1),
dos rechazos enfáticos \scripture{¡de ningún modo!}. Romanos 6:2, 6:15.
Una cadena de explicaciones introducidas por \scripture{porque} GAR, y
una afirmación resumida en el versículo 10.\end{paraHtwo}

\begin{paraHtwo}El tema no es comportamiento aislado, sino
\textbf{estado, dominio y pertenencia}. Pablo continúa el lenguaje de
\textbf{reinos} introducido en Romanos 5: el \fillin{reinado} del pecado
en la muerte (Romanos 5:21), y el reinado de la gracia por medio de la
...
\item
  El pecado está \fillin{ligado} a un solo acto y a una sola persona
  (5:18-19).
\item
  Finalmente se muestra que el \fillin{pecado} reina, y la gracia reina
  sobre él (5:20-21).
\end{itemize}
...
\subsection{Romanos 6:3--7 muertos al pecado, unidos a
Cristo}\label{romanos-637-muertos-al-pecado-unidos-a-cristo}
...
\item
  Lo que ocurrió con Cristo \fillin{cuenta} como ocurrido para el
  creyente.
\end{itemize}
...
\item
  Es representativa porque actuó como \fillin{cabeza} de una humanidad,
  llevando a su pueblo en su muerte.
\end{itemize}
...
\subsection{Romanos 6:8-10 Vivos para Dios, ya no bajo el dominio del
pecado}\label{romanos-68-10-vivos-para-dios-ya-no-bajo-el-dominio-del-pecado}
...
ejercer control o autoridad soberana  alguien. 
\end{definitionbox}
\end{center}
...
\subsection{Romanos 6:11--14 Considerarse muertos al pecado y vivos para
Dios}\label{romanos-61114-considerarse-muertos-al-pecado-y-vivos-para-dios}

\begin{paraHtwo}(La gracia redefine el marco en el que se vive la obediencia)\end{paraHtwo}

\begin{paraHtwo}El problema \fillin{práctico} que Pablo aborda. Hasta aquí, Pablo ha
establecido hechos objetivos: El creyente murió con Cristo (Romanos
6:2--4). El viejo hombre fue crucificado (Romanos 6:6). El pecado fue
despojado de su poder como amo (Romanos 6:6--7). El creyente resucitó
con Cristo para una nueva vida (Romanos 6:4--5, 6:8).\end{paraHtwo}
...
\begin{paraHtwo}La respuesta de Pablo es otra: el \fillin{problema} no es falta de
poder, sino \textbf{falta de contar correctamente con la realidad}. En
la práctica, el creyente puede vivir como si aún perteneciera al antiguo
dominio, aunque ya no sea así.\end{paraHtwo}
...
\begin{center}
\begin{definitionbox}{lujurias - EPITHUMIA}
...
\item
  Pablo habla de ``el pecado'' como algo que puede reinar. Es lenguaje
  de dominio, no simplemente de actos aislados.
\end{itemize}
...
\tightlist
\item
  Pablo ubica el reinado ``en el cuerpo mortal'', pero no para culpar al
  cuerpo como si el cuerpo fuese el origen del mal. El cuerpo es el
  instrumento por el cual un reinado se expresa.
\item
...
\tightlist
\item
  El punto no es \fillin{discutir} si, ``si ya me presenté, todavía
  puedo no obedecer''.
\item
  El punto de Pablo es: no te presentes, porque presentar es colocarte
  bajo ese funcionamiento, y bajo ese funcionamiento la obediencia
  \fillin{sigue}.
\end{itemize}
...
\begin{itemize}
\item
  \begin{paraHthree}``no presenten sus miembros al \fillin{pecado}''\end{paraHthree}
\item
  \begin{paraHthree}``preséntense a Dios''\end{paraHthree}
\item
  \begin{paraHthree}``y sus miembros a \fillin{Dios} como instrumentos de justicia''\end{paraHthree}
\end{itemize}
...
\begin{itemize}
\item
  \begin{paraHthree}Romanos 6 explica el \fillin{marco} de dominio: no permitir reinado, no
  presentarse, presentarse a Dios.\end{paraHthree}
\item
  \begin{paraHthree}\fillin{Santiago} 1 explica el mecanismo de la tentación: deseo → pecado
  → muerte.\end{paraHthree}
\end{itemize}
...
\tightlist
\item
  Romanos responde: ¿bajo qué gobierno estás operando cuando obedeces
  \fillin{deseos}?
\item
  Santiago responde: ¿cómo funciona internamente la tentación cuando el
  deseo opera?
\end{itemize}
...
\begin{itemize}
\item
  \begin{paraHthree}Santiago \fillin{excluye} explícitamente a Dios como fuente de la
  tentación:\end{paraHthree}
\item
  \begin{paraHthree}Dios no tienta a nadie.\end{paraHthree}
\item
  \begin{paraHthree}La tentación ocurre cuando uno es \fillin{atraído} por su propio deseo.\end{paraHthree}
\end{itemize}
...
\begin{itemize}
\item
  \begin{paraHthree}Ese deseo no \fillin{tiene} su origen en Dios.\end{paraHthree}
\item
  \begin{paraHthree}Santiago no desarrolla el origen \fillin{último} de la corrupción
  humana, pero sí fija el punto moral esencial: la fuente de la tentación
  no es Dios.\end{paraHthree}
\end{itemize}
...
\begin{anchorblock}{ni presenten los miembros de su cuerpo al pecado}

\headingfive{Presentar los miembros es un \fillin{acto} consciente de disponibilidad.}

\begin{center}
\begin{definitionbox}{Presentar - PARISTÁNETE}
...
\begin{anchorblock}{como instrumentos de iniquidad}
...
\begin{anchorblock}{sino preséntense ustedes mismos a Dios}
...
\subsection{Romanos 6:15--19 ¿Pecaremos porque no estamos bajo la
ley?}\label{romanos-61519-pecaremos-porque-no-estamos-bajo-la-ley}

\begin{paraHtwo}(La libertad no \fillin{elimina} el señorío; lo redefine)\end{paraHtwo}
...
\tightlist
\item
  presentarse → obedecer su deseos → servir como esclavo → producir un
  resultado (\fillin{muerte} o vida)
\end{itemize}
...
(participio aoristo , nominativo masculino plural), hacer que alguien quede liberado de control u obligación, puesto en libertad.
\end{definitionbox}
\end{center}

\begin{center}
\begin{definitionbox}{siervos - DOULO}
(aoristo de indicativo pasivo, segunda persona del plural),  bajo control total, someter a.
\end{definitionbox}
\end{center}
...
existencia humana considerada en su debilidad o limitación;  caracterizada por fragilidad. 
\end{definitionbox}
\end{center}
...
\subsection{Romanos 6:20--23 La paga del pecado y el don de
Dios}\label{romanos-62023-la-paga-del-pecado-y-el-don-de-dios}

\begin{paraHtwo}(Toda vida produce \fillin{fruto} según el dominio que gobierna)\end{paraHtwo}
...
\item
  \scripture{hechos siervos de Dios} (nuevo señorío, \fillin{nueva}
  pertenencia)
\end{itemize}
...
\item
  \begin{paraHthree}El pecado paga muerte \fillin{como} salario.\end{paraHthree}
\item
...
\subsection{Romanos 7:1--3 Un ejemplo: el matrimonio y la
muerte}\label{romanos-713-un-ejemplo-el-matrimonio-y-la-muerte}

\begin{paraHtwo}(la relación del creyente con la \fillin{ley} ha terminado de manera
definitiva)\end{paraHtwo}
...
\tightlist
\item
  El matrimonio crea un \fillin{nuevo} estatus legal: ``soltero/a'' →
  ``casado/a''.
\end{itemize}
...
\subsection{Romanos 7:4-7 - Muertos a la ley para pertenecer a
Cristo}\label{romanos-74-7---muertos-a-la-ley-para-pertenecer-a-cristo}
...
\subsection{Romanos 7:7-12 La Ley no es pecado, lo
revela}\label{romanos-77-12-la-ley-no-es-pecado-lo-revela}
...
\subsubsection{Romanos 7:10}\label{romanos-710}
...
\tightlist
\item
  El conocimiento apela a los sentidos y produce \fillin{falsa}
  seguridad. 1 Corintios 8:1
\item
  Cumplir mandamientos \fillin{genera} conducta observable, control y
  seguridad. Romanos 7:10--13
\item
  Descansar en la ley \fillin{produce} confianza en lo visible. Romanos
  2:17--20
\item
  Celo por Dios pensando que la obediencia es vida (produce alivio moral
  inmediato) (Romanos 10:2). El control se \fillin{siente} mejor que la
  dependencia por fe.
\end{itemize}
...
\tightlist
\item
  El engaño del pecado es \fillin{sutil} y usa cosas buenas para ejercer
  su astucia.
\end{itemize}
...
\item
  La tentación existe, pero Dios provee lo necesario \fillin{para} que
  no nos engañe ni ejerza poder sobre nosotros.
\end{itemize}
...
\tightlist
\item
  La verdad ocupa su \fillin{lugar} en nosotros y produce fruto por la
  obra de Dios.
\item
  Lo que proviene de \fillin{Dios} se discierne por la fe, no por los
  sentidos.
\end{itemize}
...
\subsection{Romanos 7:13-20 El pecado que habita en
mi}\label{romanos-713-20-el-pecado-que-habita-en-mi}
...
\tightlist
\item
  No hago el bien que deseo, sino el mal que no \fillin{quiero} (Romanos
  7:19)
\item
  Con la mente \fillin{sirvo} a la ley de Dios, pero en los miembros a
  la ley del pecado (Romanos 7:25)
\end{itemize}
...
\item
  No es el cuerpo físico en sí \fillin{mismo}. El pecado habita en el
  cuerpo, pero no es el cuerpo.
\end{itemize}
...
\subsection{Romanos 7:21-23 La ley del pecado que me lleva
cautivo}\label{romanos-721-23-la-ley-del-pecado-que-me-lleva-cautivo}
...
\subsection{Romanos 7:24-25 ¿Quién me
librará?}\label{romanos-724-25-quiuxe9n-me-libraruxe1}
...
\item
  ...
  son maneras para liberarse del \fillin{pecado}. Colosenses 2:20-23
\end{itemize}
...
\subsection{Romanos 8:1-4: Ninguna condenación en Cristo
Jesús}\label{romanos-81-4-ninguna-condenaciuxf3n-en-cristo-jesuxfas}

\begin{paraHtwo}Romanos 8:1 \textbf{retoma directamente} el \fillin{clamor} y la tensión
no resuelta de Romanos 7:24--25. El paso no es explicativo (cómo), sino
...
Gramaticalmente, ninguno de los versículos funciona de \fillin{manera}
...
veredicto judicial adverso; resultado  de un juicio negativo. 
\end{definitionbox}
\end{center}
...
\begin{anchorblock}{Sin embargo, la Ley es débil por causa de nuestra carne.}
...
\subsection{Romanos 8:5-11 Vivir según la carne o según el
Espíritu}\label{romanos-85-11-vivir-seguxfan-la-carne-o-seguxfan-el-espuxedritu}

\begin{paraHtwo}Romanos 8:5--11 no \fillin{inicia} un tema nuevo; desarrolla lo que
significa \scripture{“andar según el Espíritu”} (8:4). El enfoque sigue
siendo explicativo, no exhortativo: Pablo describe realidades, no manda
...
\subsection{Romanos 8:12-17 Hijos de Dios y herederos con
Cristo}\label{romanos-812-17-hijos-de-dios-y-herederos-con-cristo}
...
\subsection{Romanos 8:18-27: La esperanza en medio del sufrimiento y la
debilidad}\label{romanos-818-27-la-esperanza-en-medio-del-sufrimiento-y-la-debilidad}
...
\subsection{Romanos 8:28-30 Llamados conforme a su
propósito}\label{romanos-828-30-llamados-conforme-a-su-propuxf3sito}
...
\item
  Dios conoce todas las cosas. 1 Juan 3:20; 1 Samuel 2:3; Salmo 44:21,
  147:5; Proverbios 15:3
\end{itemize}
...
\subsection{Romanos 8:31-34 ¿Quién acusará o
condenará?}\label{romanos-831-34-quiuxe9n-acusaruxe1-o-condenaruxe1}
...
\subsection{Romanos 8:35-39 Nada nos separará del amor de
Dios}\label{romanos-835-39-nada-nos-separaruxe1-del-amor-de-dios}
...
\begin{anchorblock}{nos podrá separar del amor de Dios que es en Cristo Jesús Señor nuestro}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={La salvación}]{images/salvacion.png}}
\caption{La salvación}
\end{figure}
